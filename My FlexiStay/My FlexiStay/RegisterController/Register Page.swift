...
class Register_Page: UIViewController {
    ...
    @IBOutlet weak var contlbl: UIButton!
    ...
    override func viewDidLoad() {
        ...
        txtf.layer.cornerRadius = 10
        txtf.textContentType = .oneTimeCode
        ...
        Textdata()
        regiimg.main(urlstring: demoimg)
...
//    func otpview() {
//
        func shouldBecomeFirstResponderForOTP(){
            do { return }
        }
...
//    self.otpText = self.textInputMode = 98
//
//       print(self.otpText)
